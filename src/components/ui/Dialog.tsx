        ...
        <>
          ...
          <motion.div
            style={{
              ...
              background: 'var(--color-surface)', borderRadius: '16px', zIndex: 51,
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px', borderBottom: '1px solid var(--color-border)' }}>
              ...
              <button onClick={onClose} style={{ background: 'none', border: 'none', fontSize: '22px', color: 'var(--color-muted)', cursor: 'pointer', lineHeight: 1, padding: '0 4px' }}>×</button>
            </div>
